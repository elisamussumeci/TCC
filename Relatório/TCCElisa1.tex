...
resultados e calculamos a diferença de \textit{Kullback-Leibler}. O $\lambda$ que minimizasse essa diferença, seria o escolhido. Vemos na tabela
...
resultados a seguir. Abaixo vemos o resultado da simulação utilizando o parâmetro escolhido:
