...
objetivo desenvolver métodos computacionais que consigam traduzir a linguagem natural em uma linguagem computacional. A utilização desses
métodos é fundamental em tarefas que envolvem a utilização de banco de dados com corpus linguístico, pois a partir deles podemos
...
\begin{description}
  ...
  \item \textbf{Bag-of-Words}
   ...
   multiplicadade, causa uma perda de informação, visto que não leva em consideração a ordem das palavras e a gramatica envolvida no texto.
