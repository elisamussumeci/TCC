...
o papel das mídias digitais no acesso à informação.\todo{incluir aqui um pargrafo sobre os tipos de midia digital}\todo{falar tambem que midias diferentes tem periodicidades, alcances , publicos e credibilidade diferentes e que isso afeta a disseminação da informação }
